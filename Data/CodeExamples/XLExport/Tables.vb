...
Namespace XLExportExamples
	Public NotInheritable Class Tables
		Private Sub New()
		End Sub
		Private Shared Sub AddTable(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat, ByVal imagesPath As String)
'			#Region "#AddTable"
...
'			#End Region ' #AddTable
		...
		Private Shared Sub DisableFiltering(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat, ByVal imagesPath As String)
...
'			#End Region ' #DisableFiltering
		...
		Private Shared Sub HiddenHeaderRow(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat, ByVal imagesPath As String)
...
'			#End Region ' #HiddenHeaderRow
		...
		Private Shared Sub HiddenTotalRow(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat, ByVal imagesPath As String)
...
'			#End Region ' #HiddenTotalRow
		...
		Private Shared Sub SideBySide(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat, ByVal imagesPath As String)
...
'			#End Region ' #SideBySideTables
		...
		Private Shared Sub TableStyle(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat, ByVal imagesPath As String)
'			#Region "#TableStyle"
			' Create an exporter instance
			Dim exporter As IXlExporter = XlExport.CreateExporter(documentFormat)
...
'			#End Region ' #TableStyle
		...
		Private Shared Sub TableStyleOptions(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat, ByVal imagesPath As String)
...
'			#End Region ' #TableStyleOptions
		...
		Private Shared Sub CustomFormatting(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat, ByVal imagesPath As String)
...
'			#End Region ' #CustomFormatting
		...
		Private Shared Sub CalculatedColumn(ByVal stream As Stream, ByVal documentFormat As XlDocumentFormat, ByVal imagesPath As String)
