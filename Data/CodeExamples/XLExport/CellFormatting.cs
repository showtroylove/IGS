...
namespace XLExportExamples {
    public static class CellFormatting {
        ...
        static void RichText(Stream stream, XlDocumentFormat documentFormat) {
            #region #RichText
            // Create an exporter instance
            IXlExporter exporter = XlExport.CreateExporter(documentFormat);
                ...
                using(IXlSheet sheet = document.CreateSheet()) {
                    ...
                    using(IXlRow row = sheet.CreateRow()) {
                        ...
                        using(IXlCell cell = row.CreateCell()) {
                            ...
                            richText.Runs.Add(new XlRichTextRun("Lorem ", XlFont.CustomFont("Arial", 14.0, XlColor.FromArgb(0xff, 0x00, 0x00))));
