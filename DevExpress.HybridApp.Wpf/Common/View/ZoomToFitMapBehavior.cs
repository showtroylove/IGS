...
namespace DevExpress.DevAV.Common.View {
    public class ZoomToFitMapBehavior : Behavior<MapControl> {
        ...
        private List<VectorLayer> mapVectorLayers;
        ...
        private void OnPaddingFactorChanged(DependencyPropertyChangedEventArgs e) {
            ZoomToFit();
        }
        protected override void OnAttached() {
            base.OnAttached();
            AssociatedObject.Loaded += MapControlLoaded;
            AssociatedObject.Unloaded += MapControlUnLoaded;
        }
        ...
        private void MapControlLoaded(object sender, RoutedEventArgs e) {
            ...
            foreach(var layer in AssociatedObject.Layers) {
        ...
        private void MapControlUnLoaded(object sender, RoutedEventArgs e) {
            foreach(var layer in mapVectorLayers)
                layer.Loaded -= DisplayItemsCollectionChanged;
        }

        private void DisplayItemsCollectionChanged(object sender, RoutedEventArgs e) {
            ZoomToFit();
        }

        private void ZoomToFit() {
            if(AssociatedObject != null && mapVectorLayers.Capacity > 0)
