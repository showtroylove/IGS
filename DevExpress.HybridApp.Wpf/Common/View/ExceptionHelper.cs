...
namespace DevExpress.Internal {
    public class ExceptionHelper {
        ...
        private static UnhandledExceptionEventArgs _arguments;
        ...
        private static string GetMessage() {
            var ex = (Exception)_arguments.ExceptionObject;
        ...
        private static void copyButton_Click(object sender, RoutedEventArgs e) => Clipboard.SetText(GetMessage());

        private static void button_Click(object sender, RoutedEventArgs e) => Environment.Exit(1);
    }
}
