...
namespace DevExpress.DevAV.ViewModels {
    ...
    /// </summary>
    public partial class ProductViewModel : SingleObjectViewModel<Product, long, IPurchasingUnitOfWork> {

        /// <summary>
        /// Creates a new instance of ProductViewModel as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static ProductViewModel Create(IUnitOfWorkFactory<IPurchasingUnitOfWork> unitOfWorkFactory = null) {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected ProductViewModel(IUnitOfWorkFactory<IPurchasingUnitOfWork> unitOfWorkFactory = null)
  ...
  /// The view model that contains a look-up collection of Pictures for the corresponding navigation property in the view.
        ...
        /// </summary>
        public CollectionViewModel<ProductCatalog, long, IPurchasingUnitOfWork> ProductCatalogDetails {
        ...
        /// </summary>
        public CollectionViewModel<OrderItem, long, IPurchasingUnitOfWork> ProductOrderItemsDetails {
        ...
        /// </summary>
        public CollectionViewModel<ProductImage, long, IPurchasingUnitOfWork> ProductImagesDetails {
