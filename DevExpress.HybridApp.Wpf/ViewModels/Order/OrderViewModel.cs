...
namespace DevExpress.DevAV.ViewModels {
    ...
    /// </summary>
    public partial class OrderViewModel : SingleObjectViewModel<Order, long, IPurchasingUnitOfWork> {

        /// <summary>
        /// Creates a new instance of OrderViewModel as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static OrderViewModel Create(IUnitOfWorkFactory<IPurchasingUnitOfWork> unitOfWorkFactory = null) {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected OrderViewModel(IUnitOfWorkFactory<IPurchasingUnitOfWork> unitOfWorkFactory = null)
  ...
  /// The view model that contains a look-up collection of Employees for the corresponding navigation property in the view.
        ...
        /// </summary>
        public CollectionViewModel<OrderItem, long, IPurchasingUnitOfWork> OrderOrderItemsDetails {
