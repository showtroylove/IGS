...
namespace DevExpress.DevAV.ViewModels {
    ...
    /// </summary>
    public partial class QuoteViewModel : SingleObjectViewModel<Quote, long, IPurchasingUnitOfWork> {

        /// <summary>
        /// Creates a new instance of QuoteViewModel as a POCO view model.
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        public static QuoteViewModel Create(IUnitOfWorkFactory<IPurchasingUnitOfWork> unitOfWorkFactory = null) {
        ...
        /// </summary>
        /// <param name="unitOfWorkFactory">A factory used to create a unit of work instance.</param>
        protected QuoteViewModel(IUnitOfWorkFactory<IPurchasingUnitOfWork> unitOfWorkFactory = null)
  ...
  /// The view model that contains a look-up collection of Employees for the corresponding navigation property in the view.
        ...
        /// </summary>
        public CollectionViewModel<QuoteItem, long, IPurchasingUnitOfWork> QuoteQuoteItemsDetails {
